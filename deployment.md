...
3. Go to ``Console`` tab of this database. Enter these 4 lines from [dbinit.sq] one by one, hitting ``Execute`` button for each line.
...
7. Copy and paste all lines from [index.js] in to it and press ``Deploy`` button.
